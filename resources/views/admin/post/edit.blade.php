                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <form id="create-post" action="{{ route('update-post',$post->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @if (isset(session('errors')['errorBag']['image']))
                                                            ...
                                                            @endforeach
                                                        @endif
                                                    <img class="img-thumbnail img-upload" src="{{ Storage::disk('s3')->url($post->image_path) }}" alt="">
                                                </div>
                                            </div>
